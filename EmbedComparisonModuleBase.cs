...
namespace DotNetNuke.Modules.EmbedComparison
{
    ...
    /// are accessible to your module's controls (that inherity from EmbedComparisonModuleBase
    /// 
    /// </summary>

    public class EmbedComparisonModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
